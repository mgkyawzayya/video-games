...
<div class="container mx-auto px-4">
    <div class="game-details border-b border-gray-800 pb-12 flex">
        ...
        <div class="ml-12 mr-64">
                    ...
                    <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                        <a href="#" class="hover:text-gray-400">
                            <svg class="w-5 h-5 fill-current" viewBox="0 0 14 16" fill="none">
                                <path d="M14 2.5v11a1.5 1.5 0 01-1.5 1.5H9.834V9.463h1.894L12 7.35H9.834V6c0-.612.17-1.028 1.047-1.028H12V3.084A15.044 15.044 0 0010.369 3C8.756 3 7.65 3.984 7.65 5.794v1.56h-1.9v2.112h1.903V15H1.5A1.5 1.5 0 010 13.5v-11A1.5 1.5 0 011.5 1h11A1.5 1.5 0 0114 2.5z" /></svg>
            ...
            <p class="mt-12">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim perferendis necessitatibus sit repudiandae amet, ut sed iste, velit dolorem laborum fuga ducimus. Nemo qui sed ad et ab repudiandae voluptate!
            </p>
    ...
    <div class="images-container border-b border-gray-800 pb-12 mt-8">
        ...
        <div class="grid grid-cols-3 gap-12 mt-8">
            <div>
                <a href="#">
                    <img src="/screenshot1.jpg" alt="screeshot" class="hover:opacity-75 transition ease-in-out duration-150">
                </a>
            </div>
            <div>
                <a href="#">
